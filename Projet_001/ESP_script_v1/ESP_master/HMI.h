...
void init_HMI() {
  ...
  attachInterrupt(emergeny_BN.PIN, emergency_pressed, RISING);
  attachInterrupt(enter_BN.PIN, enter_pressed, RISING);
  attachInterrupt(back_BN.PIN, back_pressed, RISING);
  attachInterrupt(up_BN.PIN, up_pressed, RISING);
  attachInterrupt(down_BN.PIN, down_pressed, RISING);
